...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#007ce6";
    }
...
function backspace_remove(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#00d5e6";
    }
...
function calculate_percentage(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#9999";
    }
}
...
function keyPressed(e) {
    ...
    if (isNumber || operators.includes(e.key) || e.key == "Enter" || e.key == dotPress || 
        ...
        if (e.key == "Enter"){
            ...
            document.getElementById("backspace_btn").style.backgroundColor  = "#000";
            backspace_remove()
        }
        else if (commaPress){
            button_number(dot)
...
function keyReleased(e){
    ...
    if (e.key == "Backspace"){
        document.getElementById("backspace_btn").style.backgroundColor  = "white";
    }
}